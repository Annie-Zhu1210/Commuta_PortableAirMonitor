"""
Fig 4.1a — Platform PM2.5 by Underground line.
...
Background bands are UK DAQI PM2.5 thresholds (DEFRA).

Reads : data/analysis/commuta_analysis.csv
        data/analysis/commuta_stops.csv
Writes: visualisation/figures/fig_perline_boxplot.pdf  (vector)
        visualisation/figures/fig_perline_boxplot.png  (300 dpi)
"""
import os
import numpy as np
import pandas as pd
...
BAND_ALPHA = 0.5
DAQI_PM25 = [(0, 35, BAND_LOW_RGB, "Low"), (35, 53, BAND_MID_RGB, "Moderate"),
             (53, 70, BAND_HIGH_RGB, "High"), (70, 1e4, BAND_VHIGH_RGB, "Very high")]


def panel(ax, metric, ylabel, ymax):
    for lo, hi, col, name in DAQI_PM25:
...
panel(ax, "pm25", "PM$_{2.5}$  (µg m$^{-3}$)", 320)

ax.set_title("Platform PM$_{2.5}$ by line",

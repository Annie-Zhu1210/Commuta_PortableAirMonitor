...
ax.text(658, 15, " WHO 24-h\n guideline", va="center", ha="left",
...
leg = ax.legend(title="Line  (within-line correlation)", loc="lower left",
                bbox_to_anchor=(0.0, 0.0), fontsize=8.3, title_fontsize=8.8,
